...
public class ProductToTheShoppingCartStepDefinitions {
	...
	public void iLookForDressAndSelectAny(String product,String product2) throws Throwable {

		PageGenerator.getInstance(HomeYourLogoPage.class, driver).findProduct(product2);
